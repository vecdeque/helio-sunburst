defmodule Sunburst.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule Sunburst.MyChannel do
        use Sunburst.Web, :channel
  ...
  """
  use Phoenix.Presence, otp_app: :sunburst,
                        pubsub_server: Sunburst.PubSub
end
